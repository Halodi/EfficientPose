...
class InferenceNode(rclpy.Node):
    def __init__(self, args:dict):
        ...
        with open(args['object_index_map_fp'], 'r') as f:
        ...
        self._model, self._image_size = build_model_and_load_weights(args['phi'], self._num_classes, self._score_threshold, args['weights_fp'])
